    ...
    >
      {loading ? (
        ...
        <SummaryCard
          ...
          otherDeduction={view.summary.otherDeduction}
        />
      )}
      ...
      {!loading && view.unpaidTotal > 0 && (
        <Link
          href="/unpaid"
          className="flex min-h-14 w-full items-center gap-2.5 rounded-full bg-coral-light py-2 pl-4 pr-5 text-[15px] font-medium text-coral-dark"
        >
          ...
          <svg className="flex-none" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" aria-hidden="true">
